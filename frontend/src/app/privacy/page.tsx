...
export const metadata = {
  ...
  description: 'Politica de confidențialitate TeInformez.eu — cum colectăm, protejăm și procesăm datele tale personale conform GDPR.',
    ...
    <div className="min-h-screen bg-white dark:bg-gray-950">
      ...
      <main className="mx-auto max-w-3xl px-4 py-10 space-y-8">
        ...
        <section className="space-y-3">
          ...
          <p className="text-slate-700 dark:text-slate-300 leading-relaxed">Colectam urmatoarele categorii de date:</p>
        ...
        <section className="space-y-3">
          ...
          <p className="text-slate-700 dark:text-slate-300 leading-relaxed">Folosim urmatoarele categorii de cookie-uri:</p>
          <ul className="list-disc list-inside text-slate-700 space-y-1">
