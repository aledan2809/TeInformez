...
?>
<div class="wrap">
    <p style="margin:0 0 6px;"><a href="<?php echo esc_url(admin_url('admin.php?page=teinformez-analytics')); ?>" style="text-decoration:none;color:#2271b1;font-size:13px;">&larr; Back to simple view</a></p>
    <h1>Visitor Analytics &mdash; Advanced</h1>
