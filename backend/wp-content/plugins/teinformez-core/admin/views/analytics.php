...
$custom_metric_values = [
    ...
    'engaged_sessions' => $stats['engaged_sessions'],
...
$ga_metric_values = [
    ...
    'engaged_sessions' => (int) ($ga_summary['engaged_sessions'] ?? 0),
...
$metric_definitions = [
    ...
    ['key' => 'sessions_per_user', 'label' => 'Sessions / User', 'format' => 'float', 'detail' => null, 'tooltip' => 'Average sessions generated by one active user in this period.'],
    ['key' => 'views_per_user', 'label' => 'Views / User', 'format' => 'float', 'detail' => null, 'tooltip' => 'Average page views generated by one active user in this period.'],
    ['key' => 'new_user_rate', 'label' => 'New User Rate', 'format' => 'percent', 'detail' => null, 'tooltip' => 'Percentage of active users who are first-time users in the selected range.'],
    ['key' => 'engaged_sessions', 'label' => 'Engaged Sessions', 'format' => 'int', 'detail' => null, 'tooltip' => 'Sessions with meaningful engagement (time, events, or multiple views).'],
    ['key' => 'events_per_user', 'label' => 'Events / User', 'format' => 'float', 'detail' => null, 'tooltip' => 'Average number of tracked events per active user.'],
    ...
    ['key' => 'newsletter_new', 'label' => 'New Subscribers', 'format' => 'int', 'detail' => 'newsletter_new', 'tooltip' => 'New newsletter subscribers added in the selected period.', 'example' => 'Example: 42 new emails joined your newsletter list between selected dates.'],
    ['key' => 'newsletter_tracked', 'label' => 'Subscriber Track Events', 'format' => 'int', 'detail' => 'newsletter_tracked', 'tooltip' => 'Tracked subscribe events triggered by users; can include retries and repeated attempts.', 'example' => 'Example: one visitor can trigger multiple subscribe events if they retry form submission.'],
    ['key' => 'delivery_sent', 'label' => 'Delivery Sent', 'format' => 'int', 'detail' => 'delivery_sent', 'tooltip' => 'Newsletter deliveries marked as sent. Example: one campaign to 1,000 recipients generates ~1,000 sent entries.', 'example' => 'Example: sending one digest to 1,000 recipients usually creates around 1,000 sent records.'],
    ['key' => 'delivery_opened', 'label' => 'Delivery Opened', 'format' => 'int', 'detail' => 'delivery_opened', 'tooltip' => 'Deliveries with open signal detected. Used to compute open rate trends.', 'example' => 'Example: if 250 of 1,000 sent emails are opened, opened count is 250 and open rate is 25%.'],
    ['key' => 'delivery_clicked', 'label' => 'Delivery Clicked', 'format' => 'int', 'detail' => 'delivery_clicked', 'tooltip' => 'Deliveries where at least one link was clicked after open.', 'example' => 'Example: if 60 recipients click any link in a campaign, clicked count is 60.'],
    ...
    ['key' => 'newsletter_active_total', 'label' => 'Active Subscribers (Total)', 'format' => 'int', 'detail' => 'newsletter_active_total', 'tooltip' => 'All active newsletter subscribers regardless of selected date range.', 'example' => 'Example: this total stays stable across short ranges and changes when users subscribe or unsubscribe.'],
];
    ...
    <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(220px,1fr));gap:12px;margin-bottom:18px;">
        ...
        ?>
            <a href="<?php echo esc_url($card_url); ?>" style="<?php echo esc_attr($card_style); ?>">
                ...
                <?php if (!empty($metric['example'])): ?>
                    <div style="color:#8c8f94;font-size:10px;line-height:1.25;">
                        <span style="cursor:help;text-decoration:underline dotted;" title="<?php echo esc_attr($metric['example']); ?>">Example</span>
                    </div>
                <?php endif; ?>
